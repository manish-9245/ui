...
import { Bell, X, Calendar, Users, AlertTriangle, CheckCircle } from "lucide-react"
...
export default function NotificationModal({ isOpen, onClose }: Readonly<NotificationModalProps>) {
